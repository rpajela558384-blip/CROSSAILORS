<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex items-center gap-5">
            @if($user->avatar)
                <img src="{{ Storage::url($user->avatar) }}" class="w-16 h-16 rounded-full object-cover ring-4 ring-brand-100" alt="">
            @else
            ...
            <div class="flex-1">
                ...
                <input id="avatar" name="avatar" type="file" accept="image/*,.gif"
